...
The landing hero loads this after first paint so Lighthouse LCP stays on the poster (`/landing/hero.webp`; see `static/landing/README.md`). Social/OG preview still uses `/og-image.webp`.
