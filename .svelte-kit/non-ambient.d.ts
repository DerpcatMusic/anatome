...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/(app)" | "/" | "/(app)/calendar" | "/callback" | "/(app)/dashboard" | "/(app)/i" | "/(app)/i/dashboard" | "/(app)/i/live" | "/(app)/i/one-on-one" | "/(app)/i/profile" | "/(app)/i/videos" | "/(app)/live-room" | "/(app)/live" | "/onboarding" | "/(app)/one-on-one" | "/(app)/profile" | "/robots.txt" | "/sitemap.xml" | "/(app)/studio" | "/(app)/studio/live" | "/(app)/studio/videos" | "/(app)/u" | "/(app)/u/calendar" | "/(app)/u/dashboard" | "/(app)/u/one-on-one" | "/(app)/u/profile" | "/(app)/u/videos" | "/(app)/videos" | "/(app)/watch" | "/(app)/אזור-אישי" | "/(app)/אחד-על-אחד" | "/התאמה" | "/(app)/וידאו" | "/(app)/חדר-לייב" | "/(app)/לוח" | "/(app)/סטודיו" | "/(app)/סטודיו/וידאו" | "/(app)/סטודיו/לייב" | "/(app)/פרופיל" | "/(app)/צפייה";
		RouteParams(): {
		...
		Pathname(): "/" | "/calendar" | "/callback" | "/dashboard" | "/i/dashboard" | "/i/live" | "/i/one-on-one" | "/i/profile" | "/i/videos" | "/live-room" | "/live" | "/onboarding" | "/one-on-one" | "/profile" | "/robots.txt" | "/sitemap.xml" | "/studio/videos" | "/u/calendar" | "/u/dashboard" | "/u/one-on-one" | "/u/profile" | "/u/videos" | "/videos" | "/watch" | "/אזור-אישי" | "/אחד-על-אחד" | "/התאמה" | "/וידאו" | "/חדר-לייב" | "/לוח" | "/סטודיו/וידאו" | "/סטודיו/לייב" | "/פרופיל" | "/צפייה";
