...
function InstructorActions($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		const { t } = useI18n();
		$$renderer.push(`<div class="instructor-actions svelte-wafgwn"><a class="action-card svelte-wafgwn"${attr("href", routePath("studioLive"))}><span class="action-card__num svelte-wafgwn">01</span> <h3 class="svelte-wafgwn">${escape_html(t.dashboard.actions.studioLive.title())}</h3> <p class="svelte-wafgwn">${escape_html(t.dashboard.actions.studioLive.desc())}</p></a> <a class="action-card svelte-wafgwn"${attr("href", routePath("studioVideos"))}><span class="action-card__num svelte-wafgwn">02</span> <h3 class="svelte-wafgwn">${escape_html(t.dashboard.actions.videos.title())}</h3> <p class="svelte-wafgwn">${escape_html(t.dashboard.actions.videos.desc())}</p></a> <a class="action-card svelte-wafgwn"${attr("href", routePath("customerCalendar"))}><span class="action-card__num svelte-wafgwn">03</span> <h3 class="svelte-wafgwn">${escape_html(t.dashboard.actions.calendar.title())}</h3> <p class="svelte-wafgwn">${escape_html(t.dashboard.actions.calendar.desc())}</p></a></div>`);
	});
}
//#endregion
