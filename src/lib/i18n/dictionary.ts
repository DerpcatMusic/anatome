...
export const dictionary: Dictionary = {
  he: {
    ...
    "onboarding.experience.new.desc": "אף פעם לא תרגלתי פילאטיס",
    "onboarding.experience.some.title": "חדשה לייט",
    "onboarding.experience.some.desc": "אני מכירה את הבסיס",
    "onboarding.experience.steady.title": "מתרגלת קבועה",
    "onboarding.experience.steady.desc": "התרגול הוא חלק משגרת השבוע שלי",
    "onboarding.equipment.title": "עם איזה ציוד את עובדת בבית?",
    "onboarding.equipment.subtitle": "",
