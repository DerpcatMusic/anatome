...
const he = {
  ...
  landing: {
    ...
    pricing: {
      ...
      recorded: { label: 'מנוי שיעורים מוקלטים', price: 'מ־[X] ₪/חודש', note: 'גישה לכל הקטלוג' },
      live: { label: 'מנוי לייב + מוקלטים', price: 'מ־[Y] ₪/חודש', note: 'שיעורים חיים בקבוצה + מאגר מוקלט' },
